...
func main() {
	...
	if err != nil {
		...
		server.RegisterCompletionProvider(symfony.NewServiceCompletionProvider(serviceIndexer.GetServiceIndex()))
		server.RegisterCompletionProvider(symfony.NewTagCompletionProvider(serviceIndexer.GetServiceIndex()))
	}
